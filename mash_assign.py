...
def cluster_identification (mash_exec, location_dict , clusters):
...
inputs = input_reader(args.cluster_file, args.assembly_file)

reference_creator(inputs[1], args.kmer_size, args.sketch_size, args.mash_exec)
...
cluster_output = cluster_identification(args.mash_exec, inputs[0] , inputs[2])
